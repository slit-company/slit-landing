...
PROJECTS = [
    {
        ...
        "overview": "Anyon은 Electron 기반 앱, 웹 서버 계층, 워커, 템플릿, E2E 테스트, Supabase 연동을 모두 포함한 풀스택 제품으로 운영되었습니다. 누적 외주 매출 ₩3,700만과 수상 2건을 함께 확보한 대표 레퍼런스입니다.",
    ...
    },
    {
        ...
        "overview": "웹사이트 제작을 넘어 운영 체계 자체를 제품 안에 내장한 사례입니다. 실제 운영에 사용되는 플랫폼으로 안정화되었습니다.",
    ...
    },
    {
        ...
        "overview": "프론트 제품 리포지토리와 Lyla-backend를 결합해 운영하는 AI 개인 비서 제품입니다. 백엔드 초기 서버 골격이 잡혀 있으며, 사용자의 하루 운영을 지속적으로 보조하는 멀티 채널 개인 비서 제품을 목표로 합니다.",
    ...
    },
    {
        ...
        "overview": "React 기반 웹 애플리케이션과 Electron 위젯, Supabase 저장 구조, OpenAI 연동을 함께 실험한 제품입니다.",
...
<section class="section" style="padding-top:40px">
  <div class="w-layout-blockcontainer container w-container">
    <div class="slit-detail-meta cols-{meta_cols}">
      {meta_cells}
    </div>
